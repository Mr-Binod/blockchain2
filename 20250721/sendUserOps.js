...
const TokenCA = "0x69573177b7eC3Cb800C76e4871C1402Fb7B6C466"
const TokenAbi = [
	{
		"inputs": [
			{
...
// 스마트 계정 사용자가 생성한 계정
const smartAccountAddress = "0x56E19ca24c6867674BAff25f32B7a62bea9647c7"; 
...
const sendEntryPoint = async () => {
	...
	const paymasterAndData = ethers.solidityPacked(["address"], ["0x564b6665F5bA89A2e78Ab888450354056B489Cad"]);
    const userOp = {
